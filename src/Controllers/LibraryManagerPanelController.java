...
public class LibraryManagerPanelController {
    ...
    @FXML
    void initialize() {/** initialization the drawers*/
    ...
    /**
   	 ...
   	 */
    public void changeAnchor() {/**Open the window*/
    	AnchorPane root;
    	    	
    	try {
			FXMLLoader loader2 = new FXMLLoader();
			loader2.setLocation(getClass().getResource("/gui/ListOfBorrowedBooks.fxml"));
			root = loader2.load(); 
			ListOfBorrowedBooksController HomepageManager = loader2.getController();
   ...
   /* public void start(Stage primaryStage) throws Exception {
    ...
    /**
   	 ...
   	 */
    public void setUser(User thisUserData) {/**Transfer user information between windows and Open the window*/
		...
		try {
			...
			loader.setLocation(getClass().getResource("/gui/LibraryManagerHomepage.fxml"));
			root = loader.load(); 
			LibraryManagerHomepageController HomepageManager = loader.getController();
			//User me = new User(MyUserData.getUserID(),MyUserData.getUsername(),MyUserData.getPassword(),MyUserData.getID(),MyUserData.getFirstName()
			//		,MyUserData.getLastName(),MyUserData.getEmail(),MyUserData.getAddedDate(),MyUserData.getPermissions(),MyUserData.getUserStatus());
			//HomepageManager.setUser(me);
			HomepageManager.setUser(MyUserData);
...
private void initDrawer() {/**initialization the drawers*/
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/LibraryManagerToolbar.fxml"));
            	...
            	if(node.getAccessibleText() != null){
                        	 ...
                        	 if(keyComb1.match(ke)) {
                        		 ...
                        		 try {
          							...
          							if(homestatus%8==0) {
          								homestatus++;
          								FXMLLoader loader2 = new FXMLLoader();
              							loader2.setLocation(getClass().getResource("/gui/LibraryManagerHomepage.fxml"));
              							root = loader2.load(); 
              							LibraryManagerHomepageController HomepageManager = loader2.getController();
              							HomepageManager.setUser(MyUserData);
             						...
             						if(keyComb2.match(ke)) {
             							...
             							try {
                     						...
                     						if(personalstatus%8==0) {
                     							personalstatus++;
                     							FXMLLoader loader2 = new FXMLLoader();
                     							loader2.setLocation(getClass().getResource("/gui/PersonalInformationByLibrarianOrManager.fxml"));
                     							root = loader2.load();
             					...
             					if(keyComb5.match(ke)) {
             						for(Node node3 : toolbar.getChildren()){
                           				if(node3.getAccessibleText().equals("LockingConfirmation")) {
                           					node3.setStyle("-fx-border-color: #FFFF8D");
                           				}
                           				else {
                           					node3.setStyle("-fx-border-color: transparent"); 
             						...
             						try {
                 						ke.consume();
                 						if(lockingstatus%8==0) {
                 							lockingstatus++;
                 							FXMLLoader loader2 = new FXMLLoader();
                     						loader2.setLocation(getClass().getResource("/gui/LockingConfirmationByManager.fxml"));
                     						root = loader2.load();
            		...
            		node.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
        				...
        				case "PersonalInformation":
        					...
        					try {
        						root = FXMLLoader.load(getClass().getResource("/gui/PersonalInformationByLibrarianOrManager.fxml"));
        						AnchorPaneTabs.getChildren().setAll(root);  
        					}
        					catch(IOException ex){
        				...
        				case "LockingConfirmation":
        					...
        					try {
        						...
        						loader2.setLocation(getClass().getResource("/gui/LockingConfirmationByManager.fxml"));
        						root = loader2.load();
        						//LockingConfirmationByManagerController Locking = loader2.getController();
        						//Locking.loadReader22(MyUserData);
